...
const Nav = () => {
    ...
    return (
        <nav
            ...
            {/* inner */}
            <div
                className={`flex w-full xl:flex-col items-center justify-between xl:justify-center gap-y-10 px-6 xl:px-0 h-[80px] xl:h-max py-8 bg-white/10 backdrop-blur-sm text-3xl xl:text-xl xl:rounded-full`}>
