            ...
            <div className={'container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6'}>
                ...
                <div className={'flex-1 flex flex-col justify-center'}>
                    ...
                    <motion.p
                        ...
                        animate='show'
                        exit='hidden'
                        className='max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-0'>10 years ago, I began freelancing as a developer.  </motion.p>
                    {/*counters*/}
                    <motion.div
                                ...
                                <div key={itemIndex}
                                    ...
                                    <div className={'flex gap-x-4'}>
                                        ...
                                        {item.icons?.map((icon, itemIndex) => {
                                            return (
                                                <div className={'text-2xl transition-all duration-50'}>{icon}</div>
                                            )
                                        })}
                                    </div>
                                </div>
